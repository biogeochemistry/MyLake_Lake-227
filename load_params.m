...
lake_params = {
    ...
    0.0223, 'w_chl',             % 47     settling velocity for Chl a (m day-1)
    1, 'Y_cp',                 % 48     NOTE: NOT USED:  yield coefficient (chlorophyll to carbon) * (carbon to phosphorus) ratio (-)   1/55*112/1 = 1
    0.0868, 'm_twty',             % 49    loss rate (1/day) at 20 deg C
    1.3104, 'g_twty',             % 50    specific growth rate (1/day) at 20 deg C
    ...
    90.0948, 'P_half',             % 53    Half saturation growth P level (mg/m3)
    ...
    0.0223, 'w_chl_2',           % 56    Settling velocity for Chl a (m day-1)
    0.00868, 'm_twty_2',           % 57    Loss rate (1/day) at 20 deg C
    1.3104, 'g_twty_2',           % 58    Specific growth rate (1/day) at 20 deg C
