...
lake_params = {
    ...
    2.0093E-04, 'PAR_sat',       % 10    PAR saturation level for phytoplankton growth (mol(quanta) m-2 s-1)
    ...
    0.0547, 'w_chl',             % 47     settling velocity for Chl a (m day-1)
    1, 'Y_cp',                 % 48     NOTE: NOT USED:  yield coefficient (chlorophyll to carbon) * (carbon to phosphorus) ratio (-)   1/55*112/1 = 1
    0.0115, 'm_twty',             % 49    loss rate (1/day) at 20 deg C
    0.8219, 'g_twty',             % 50    specific growth rate (1/day) at 20 deg C
    ...
    7.6398, 'P_half',             % 53    Half saturation growth P level (mg/m3)
    1.2207, 'N_half',             % 54    Half saturation growth N level (mg/m3)
    2.0093E-04, 'PAR_sat_2',     % 55    PAR saturation level for phytoplankton growth (mol(quanta) m-2 s-1)
    0.015, 'beta_chl_2',       % 56    Optical cross_section of chlorophyll (m2 mg-1)
    0.0540, 'w_chl_2',           % 57    Settling velocity for Chl a (m day-1)
    0.0115, 'm_twty_2',           % 58    Loss rate (1/day) at 20 deg C
    0.637, 'g_twty_2',           % 59    Specific growth rate (1/day) at 20 deg C
    5.3158, 'P_half_2',         % 60    Half saturation growth P level (mg/m3)
