...
lake_params = {
    ...
    2.46E-04, 'PAR_sat',       % 10    PAR saturation level for phytoplankton growth (mol(quanta) m-2 s-1)
    ...
    0.0785, 'w_chl',             % 47     settling velocity for Chl a (m day-1)
    ...
    0.02, 'P_half',             % 53    Half saturation growth P level (mg/m3)
    0, 'N_half',             % 54    Half saturation growth N level (mg/m3)
    ...
    0.6, 'g_twty_2',           % 59    Specific growth rate (1/day) at 20 deg C
    0.02, 'P_half_2',         % 60    Half saturation growth P level (mg/m3)
