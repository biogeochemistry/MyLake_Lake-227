...
lake_params = {
    ...
    2.91E-04, 'PAR_sat',       % 10    PAR saturation level for phytoplankton growth (mol(quanta) m-2 s-1)
    ...
    0.0919, 'w_chl',             % 47     settling velocity for Chl a (m day-1)
    ...
    1.7, 'g_twty',             % 50    specific growth rate (1/day) at 20 deg C
    ...
    77.2, 'P_half',             % 53    Half saturation growth P level (mg/m3)
    2.91E-04, 'PAR_sat_2',     % 54    PAR saturation level for phytoplankton growth (mol(quanta) m-2 s-1)
    0.015, 'beta_chl_2',       % 55    Optical cross_section of chlorophyll (m2 mg-1)
    0.0919, 'w_chl_2',           % 56    Settling velocity for Chl a (m day-1)
    0.01, 'm_twty_2',           % 57    Loss rate (1/day) at 20 deg C
    1.7, 'g_twty_2',           % 58    Specific growth rate (1/day) at 20 deg C
    77.2, 'P_half_2',         % 59    Half saturation growth P level (mg/m3)
