...
diazoprop.out.plot <-
ggplot(subset(phyto.out.summary, week >19), aes(x = week, y = diazo.mean)) +
  geom_line(aes(color = Period)) +
  geom_ribbon(aes(ymin = lowerCI, ymax = upperCI, fill = Period), alpha = 0.2) +
  labs(y = "Proportion diazotroph", x = "") +
...
ggplot(phyto.obs.summary, aes(x = week, y = diazo.mean)) +
  geom_line(aes(color = Period)) +
  geom_ribbon(aes(ymin = lowerCI, ymax = upperCI, fill = Period), alpha = 0.2) +
  labs(y = "Proportion diazotroph") +
  scale_color_manual(values = c("#f99d15ff", "#d14a42ff", "#240c4cff")) +
  scale_fill_manual(values = c("#f99d15ff", "#d14a42ff", "#240c4cff")) +
  theme(legend.position = "none")

diazoprop.plot <-
plot_grid(diazoprop.out.plot, diazoprop.obs.plot, nrow = 2)

# ggsave("./Figures_Revision/Diazoprop.jpg", diazoprop.plot, dpi = 300, 
