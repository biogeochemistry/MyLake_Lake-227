...
mod.match.daily <- mod.match.daily[-c(1:6, 6863:6887),]
...
mod.match.daily <- mutate(mod.match.daily, Week = format(mod.match.daily$date, "%W/%Y"))
mod.match.weeklyPP <- aggregate(mod.match.daily[c(5,9)], list(mod.match.daily$Week), FUN = sum)
