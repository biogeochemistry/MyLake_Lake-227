...
p <- ggplot() +
  ...
  theme(legend.position = c(0.9,0.9)) # TP by time
#print(p)
...
p2 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "blue")) +
  theme(legend.position = c(0.9,0.9)) #TDP by time
#print(p2)
...
p7 <- ggplot(mod2.match, aes(x = date)) +
  ...
  theme(legend.position = c(0.9,0.9)) #all temp by time
...
p8 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "red")) +
  theme(legend.position = c(0.9,0.9)) #O2 2m by time
...
p9 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "red")) +
  theme(legend.position = c(0.9,0.9)) #O2 3m by time
...
p10 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "red")) +
  theme(legend.position = c(0.9,0.9)) #O2 4m by time
...
p11 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "red")) +
  theme(legend.position = c(0.9,0.9)) #O2 6m by time
...
p12 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "red")) +
  theme(legend.position = c(0.9,0.9)) #O2 8m by time
...
p13 <- ggplot() +
  ...
  xlab(" ") +
  scale_colour_manual("", breaks = c("Observed", "Modeled"), values = c("black", "red")) +
  theme(legend.position = c(0.9,0.9)) #O2 10m by time

p18 <- ggplot(mod3.match, aes(x = date)) +
  geom_line(data = mod2, aes(x = date, y = mod.Oxy4m, col = "4m"), size = 0.5) +
  geom_line(data = mod2, aes(x = date, y = mod.Oxy6m, col = "6m"), size = 0.5) +
  geom_line(data = mod2, aes(x = date, y = mod.Oxy10m, col = "10m"), size = 0.5) +
  geom_point(data = mod3.match, aes(x = date, y = obs.O2.4m, col = "4m"), pch = 19, size = 1) +
  geom_point(data = mod3.match, aes(x = date, y = obs.O2.6m, col = "6m"), pch = 19, size = 1) +
  geom_point(data = mod3.match, aes(x = date, y = obs.O2.10m, col = "10m"), pch = 19, size = 1) +
  ylim(0,12) +
  ylab(expression(Oxygen ~ (mg / L))) +
  xlab(" ") +
  scale_colour_manual("", breaks = c("4m", "6m", "10m"), values = c("#6baed6", "#3182bd", "#08519c")) +
...
require(gridExtra)
grid.arrange(p, p2, p3, ncol = 1) #Fe 10m by time
...
q <- ggplot(mod.match, aes(x = obs.TP, y = mod.TP, color=Month)) +
  ...
  theme(legend.position=c(0.9, 0.8)) #TP regression
#print(q)
...
q2 <- ggplot(mod.match, aes(x = obs.TDP, y = mod.TDP, color=Month)) +
  ...
  scale_color_distiller(palette="YlGnBu") +
  theme(legend.position=c(0.9, 0.8)) #TDP regression
#print(q2)
...
q7 <- ggplot(mod.match, aes(x = obs.TDP, y = mod.TDP, color=Year)) +
  geom_point(pch = 19, size = 1.5) +
  geom_abline(slope=1, intercept=0) + 
  scale_x_continuous(limits=c(0,50)) + scale_y_continuous(limits=c(0,50)) +
  xlab(expression(TDP ~ Observed ~ (mu*g / L))) +
...
rmse <- sqrt(mse)
rmse
NSE(mod2.match$mod.Temp1m, mod2.match$obs.Temp1m)
...
rmse <- sqrt(mse)
rmse
NSE(mod2.match$mod.Temp4m, mod2.match$obs.Temp4m)
...
rmse <- sqrt(mse)
rmse
NSE(mod2.match$mod.Temp9m, mod2.match$obs.Temp9m)
...
rmse <- sqrt(mse)
rmse
NSE(mod.match$mod.chla, mod.match$obs.chla)
...
rmse <- sqrt(mse)
rmse
NSE(mod.match$mod.TDP, mod.match$obs.TDP)
...
rmse <- sqrt(mse)
rmse
NSE(mod.match$mod.TP, mod.match$obs.TP)

O2regression2m <- lm(mod3.match$obs.O2.2m ~ mod3.match$mod.Oxy2m)
summary(O2regression2m)
mse <- mean(residuals(O2regression2m)^2); rmse <- sqrt(mse); rmse
NSE(mod3.match$mod.Oxy2m, mod3.match$obs.O2.2m )

O2regression3m <- lm(mod3.match$obs.O2.3m ~ mod3.match$mod.Oxy3m)
summary(O2regression3m)
mse <- mean(residuals(O2regression3m)^2); rmse <- sqrt(mse); rmse
NSE(mod3.match$mod.Oxy3m, mod3.match$obs.O2.3m )

O2regression4m <- lm(mod3.match$obs.O2.4m ~ mod3.match$mod.Oxy4m)
summary(O2regression4m)
mse <- mean(residuals(O2regression4m)^2); rmse <- sqrt(mse); rmse
NSE(mod3.match$mod.Oxy4m, mod3.match$obs.O2.4m )

O2regression6m <- lm(mod3.match$obs.O2.6m ~ mod3.match$mod.Oxy6m)
summary(O2regression6m)
mse <- mean(residuals(O2regression6m)^2); rmse <- sqrt(mse); rmse
NSE(mod3.match$mod.Oxy6m, mod3.match$obs.O2.6m )

O2regression8m <- lm(mod3.match$obs.O2.8m ~ mod3.match$mod.Oxy8m)
summary(O2regression8m)
mse <- mean(residuals(O2regression8m)^2); rmse <- sqrt(mse); rmse
NSE(mod3.match$mod.Oxy6m, mod3.match$obs.O2.6m )

O2regression10m <- lm(mod3.match$obs.O2.10m ~ mod3.match$mod.Oxy10m)
summary(O2regression10m)
mse <- mean(residuals(O2regression10m)^2); rmse <- sqrt(mse); rmse
NSE(mod3.match$mod.Oxy10m, mod3.match$obs.O2.10m )
