...
p8 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.2m, col = "Observed"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy2m, col = "Modeled"), size = 0.5) +
  #ylim(0,10) +
...
p9 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.3m, col = "Observed"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy3m, col = "Modeled"), size = 0.5) +
  #ylim(0,10) +
...
p10 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.4m, col = "Observed"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy4m, col = "Modeled"), size = 0.5) +
  #ylim(0,10) +
...
p11 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.6m, col = "Observed"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy6m, col = "Modeled"), size = 0.5) +
 # ylim(0,10) +
  ylab(expression(Oxygen ~ (mg / L))) +
  xlab(" ") +
  scale_colour_manual("", 
...
p12 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.8m, col = "Observed"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy8m, col = "Modeled"), size = 0.5) +
  #ylim(0,10) +
  ylab(expression(Oxygen ~ (mg / L))) +
  xlab(" ") +
  scale_colour_manual("", 
...
p13 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.10m, col = "Observed"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy10m, col = "Modeled"), size = 0.5) +
  #ylim(0,10) +
...
p18 <- ggplot(mod3.match, aes(x = date)) +
  geom_point(aes(y = obs.O2.2m, col = "2m"), pch = 19, size = 1) +
  geom_point(aes(y = obs.O2.4m, col = "4m"), pch = 19, size = 1) +
  geom_point(aes(y = obs.O2.10m, col = "10m"), pch = 19, size = 1) +
  geom_line(aes(y = mod.Oxy2m, col = "2m"), size = 0.5) +
  geom_line(aes(y = mod.Oxy4m, col = "4m"), size = 0.5) +
  geom_line(aes(y = mod.Oxy10m, col = "10m"), size = 0.5) +
  ylim(0,12) +
  ylab(expression(Oxygen ~ (mg / L))) +
  xlab(" ") +
  scale_colour_manual("", 
